...
** linux_client
*** program
linux, linux-headers, base-devel, grub, memtest86+, xterm, pacman, ntp, gparted, gcc, gcc-fortran, gdb, strace, nvidia, gtk, qt, clisp, python, nodejs, npm, perl, tcl, tk, git, subversion, openjdk, icedtea-web, ttf-dejavu, chromium, pepper-flash, rsync, transmission-gtk, wget, axel, filezilla, p7zip, unzip, unrar, mksh, tcsh, tree, gvim, emacs, texlive-most, texlive-langchinese, imagemagick, gimp, dia, inkscape, recordmydesktop, gv, xchm, calc, gnuplot, graphviz, cups-pdf, mplayer, smplayer, gstreamer, portmidi, x264, ffmpeg, bchunk, flac, aspell-en, hunspell-en, tigervnc, freerdp, vpnc, openconnect, openvpn, pptpclient, celestia, gnugo, sudo, fuse, libreoffice, nginx, postgresql, mariadb, libdvdread, libdvdcss, libdvdnav, networkmanager, gnome, dosfstools, curl, blas, lapack, shotwell, openssh, xorg-server, xf86-input-libinput, xz, android-tools
*** multimedia
