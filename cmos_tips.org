...
** client only
*** de and exts
gnome, EasyScreenCast, Screenshot Tool, system-monitor
*** program
gparted, nvidia, icedtea-web, pepper-flash, filezilla, tcsh, mksh, zsh, texlive-most, texlive-langchinese, imagemagick, gimp, dia, inkscape, gv, xchm, gnuplot, graphviz, cups-pdf, bchunk, aspell-en, hunspell-en, tigervnc, freerdp, celestia, gnugo, libreoffice, android-tools, read-edid
*** multimedia
