...
** common gui
xorg-server, xorg-xinit, xorg-xrandr, xorg-xprop, xautolock, xterm, i3-wm, i3status, i3lock, gvim, emacs, tk, openjdk, feh, pulseaudio, pulseaudio-alsa, ponymix, gstreamer, portmidi, flac, x264, x265, ffmpeg, mpv, smplayer, chromium, ttf-dejavu, ttf-font-awesome
** linux_server only
