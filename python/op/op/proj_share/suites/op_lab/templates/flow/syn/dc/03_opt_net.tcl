...
sh /usr/bin/perl {{cur.config_plugins_dir}}/dc_scripts/check_violation_summary.pl {{cur.cur_flow_rpt_dir}}/05_SYN_{{local.lib_corner}}.rpt > {{cur.cur_flow_rpt_dir}}/05_SYN_{{local.lib_corner}}.sum
...
sh /usr/bin/perl {{cur.config_plugins_dir}}/dc_scripts/check_violation_summary.pl {{cur.cur_flow_rpt_dir}}/06_SYN_{{local.lib_corner}}.rpt > {{cur.cur_flow_rpt_dir}}/06_SYN_{{local.lib_corner}}.sum
