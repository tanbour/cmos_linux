...
ln -sf {{pre.flow_data_dir}}/{{pre.stage}}/${pre_stage}.{{env.BLK_NAME}}.merge.gds.gz {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.merge.gds.gz
endif

if ( -e {{pre.flow_data_dir}}/{{pre.stage}}/${pre_stage}.{{env.BLK_NAME}}.dummy_merge.gds.gz ) then
ln -sf {{pre.flow_data_dir}}/{{pre.stage}}/${pre_stage}.{{env.BLK_NAME}}.dummy_merge.gds.gz {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.dummy_merge.gds.gz
endif

ln -sf {{pre.flow_data_dir}}/{{pre.stage}}/${pre_stage}.{{env.BLK_NAME}}.lvs.v.gz {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.lvs.v.gz

#===================================================================
#===================  delete existing tmp cdl file =================
#===================================================================
if ( -e {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.lib_to_cdl_by_v2lvs.cdl) then
rm -f {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.lib_to_cdl_by_v2lvs.cdl
endif
touch {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.lib_to_cdl_by_v2lvs.cdl
...
set v2lvs_cdl_tmp  = "{{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.lib_to_cdl_by_v2lvs.cdl"
...
v2lvs -64  -v ${vnet_file}  -s ${v2lvs_cdl_tmp} -o {{cur.cur_flow_data_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.cdl

echo "finish" `date "+%F %T %a"` >> $run_time
grep "Running" ./v2lvs.log >! {{cur.cur_flow_log_dir}}/${pv_func}/${cur_stage}.{{env.BLK_NAME}}.log
