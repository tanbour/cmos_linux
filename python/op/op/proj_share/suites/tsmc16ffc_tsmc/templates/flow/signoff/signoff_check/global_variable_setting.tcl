...
set output_rpt_signal                   "check_clock_wire_length.rpt"                   ;# default report's name <> ;you can modify it 
#clock wire 
...
set output_rpt_clock                    "check_clock_wire_length.rpt"                   ;# default report's name <> ;you can modify it 

#Item: Check tie fanout and wire length
# fanout
set tie_wire_length_limitation          "100"                                           ;# default value <> 
set output_rpt_tie                      "check_tie_connection.rpt"                      ;# default report's name <> ;you can modify it 
#net_length
set tie_cell_type                       "TIE*"                              ;# need to set {TIE*/ TIEL* /TIEH*}
set output_rpt_tie_length               "check_tie_net_length.rpt"                      ;# default report's name <> ;you can modify it
# 1'b0 1'b1
set output_rpt_tie_insertion            "check_tie_insertion.rpt"                       ;# default report's name <> ;you can modify it
...
set output_rpt_mem_orientation          "check_memory_orientation.rpt"                  ;# default report's name <> ; you can modify it
...
set output_rpt_ip_isolation             "check_ip_isolation.rpt"
#port
set footprint_buf                       "BUF"                                           ;# default value <>
set footprint_inv                       "INV"                                           ;# default value <>
set ip_reference_names                  "FA1D0BWP16P90CPDULVT XOR3D0BWP16P90CPDULVT"
...
set output_rpt_port_isolation           "check_port_isolation.rpt"
...
set output_rpt_open_pin                 "check_open_input_pin.rpt"                       ;# default report's name <> ; you can modify it


#Item: Check filler / dcap / eco cells
set filler_cell_type                    "ref_name =~ FILL*"                              ;# filler cell's ref_name
set output_rpt_filler                   "check_filler_area_number.rpt"                   ;# default report's name <> ; you can modify it 
set dcap_cell_type                      "ref_name =~ DCAP*"                              ;# dcap cell's ref_name
set output_rpt_dcap                     "check_dcaps_area_number.rpt"                    ;# default report's name <> ; you can modify it 
set eco_cell_type                       "ref_name =~ GDCAP*"                             ;# ECO cell's ref_name
set output_rpt_eco                      "check_eco_area_number.rpt"                      ;# default report's name <> ; you can modify it 
...
set output_rpt_multi_driver             "check_multi_driver.rpt"                         ;# default report's name <> ;you can modify it
#Item:check multi-drive net 
set output_rpt_multi_drive_net          "check_multi_drive_net.rpt"                      ;# default report's name <> ;you can modify it
#Item:check multi-drive cell 
set output_rpt_multi_cell_type          "check_multi_drive_cell_type.rpt"                ;# default report's name <> ;you can modify it
...
set output_rpt_dont_use_cell            "check_dont_use_cell.rpt"                        ;# default report's name <> ;you can modify it

#Item:check open input pin 
set output_rpt_open                     "check_open_input_pin.rpt"                       ;# default report's name <> ;you can modify it

#Item:check dont touch net 
set output_rpt_dont_touch_net           "check_dont_touch_net.rpt"                       ;# default rptort's name <> ;you can modify it
...
set output_rpt_clock_pt                 "check_clock_net_xtalk_delta_delay.rpt"          ;# default report's name <> ;you can modify it

#Item:check signal Xtalk noise delay penalty
set signal_threshold                    "0.02"                                           ;# default value is 0.02<20ps>;you can modify it 
set output_rpt_signal_pt                "check_signal_net_xtalk_delta_delay.rpt"         ;# default report's name <> ;you can modify it
...
set output_rpt_ip_duty                  "check_ip_duty.rpt"                              ;# default report's name <> ;you can modify it
...
set output_rpt_clock_cell               "report_clock_cell_type.rpt"                     ;# default report's name <> ;you can modify it
