...
proc check_port_isolation { { wire_length_limitation 50 } { output check_port_isolation.rep } } {
  ...
  set pin_length_iso_list ""
	...
	foreach_in_collection port $ports {
		...
		set connect_cell [ get_cells -of [ get_pins -of [ get_nets $net -quiet ] -leaf -quiet ] -quiet ]
	...
	foreach physical_reference_name $physical_partition_reference_names {
		...
		foreach block_name $block_names {
			set block_pins [ get_attr [ get_pins -of $block_name ] full_name ]
			foreach pin $block_pins {
				set block_net [ get_net -of [ get_pins $pin ] -quiet ]
				set connect_cell [ remove_from_collection [ get_cells -of [ get_pins -of [ get_nets $block_net -quiet ] -leaf -quiet ] -quiet ] [ get_cells $block_name ] ]
