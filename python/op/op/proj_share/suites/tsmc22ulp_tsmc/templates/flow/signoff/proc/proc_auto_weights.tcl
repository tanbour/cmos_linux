...
#adds weights to pathgroups based on wns/tns/nvp
#design needs to be mapped or placed
#recommended to rerun from the beginning for best qor
#recommended to run with no existing weights (use -reset to clear any)
#not recommended to run again and again or change weights thru the flow
#################################################

# Automatically assign path group weights based on WNS/TNS/NVP WNS and TNS are adjusted for clock period"
# if mcmm only does analysis and affects the current_scenrio, run the script again after setting current_scenario to desired scenario
# Version 1.1
	# Changed default to -wns -tns -nvp
