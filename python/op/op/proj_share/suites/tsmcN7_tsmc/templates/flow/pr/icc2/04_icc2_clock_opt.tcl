...
{% include  'icc2/tsmcN7_settings/N7_settings_common_opt.tcl' %}
{% include  'icc2/tsmcN7_settings/N7_settings_common_route.tcl' %}

puts "Alchip-info: settings tsmcN7_settings/icc2_clock.tcl "
{% include  'icc2/tsmcN7_settings/N7_settings_clock_opt_cts.tcl' %}

source -e -v "{{env.PROJ_SHARE_CMN}}/icc2_common_scripts/N7_settings_icc2_dont_use.tcl"
#source spacing rule
