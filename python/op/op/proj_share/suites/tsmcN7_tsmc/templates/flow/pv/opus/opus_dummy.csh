...
#------------------ rule deck file name-----------------------
set CAL_DECKS_METAL       = "${CAL_DECKS_METAL}"
set CAL_DECKS_ODPO        = "${CAL_DECKS_ODPO}"
set CAL_DECKS_COD         = "${CAL_DECKS_COD}"
...
echo "Alchip-Info: $dummy_name rule deck does not exist, fail to run $dummy_name. Force exit!"
set metal_results_db_key_word = ""
exit
endif 
...
set dummy_topCell_name    = "${dummy_name}_{{env.BLK_NAME}}"
...
set scr_merge_file        = "{{cur.flow_scripts_dir}}/{{cur.stage}}/${cur_stage}.{{env.BLK_NAME}}.${dummy_name}_merge.il"
