...
# CREATOR     : Alchip                                
# DATE        : 2018-03-03                                                   
# DESCRIPTION : check  multi-drive cell type  in ICC2 
...
proc check_multi_drive_cell_type { {output_rpt_multi_cell_type check_multi_drive_cell_type.rpt} } {
     puts "Alchip-info: Starting to signoff check multi-driver cell type in ICC2\n"
	...
	foreach_in_collection net [get_nets -hierarchical -top_net_of_hierarchical_group -segments] {
     ...
     close $file
     puts "Alchip-info: Completed to signoff check multi-driver cell type in ICC2\n"
}
