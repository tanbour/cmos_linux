...
urlpatterns = [
    ...
    path("runner/signoffs/", views.RunnerSignoff.as_view(), name="runner_signoff"),
    ...
    path("flowcmps/", views.FlowCmpList.as_view(), name="flow_cmp_list"),
    ...
    path("proj_signoffs/<pk>/", views.ProjSignoffDetail.as_view(), name="proj_signoff_detail")
]
